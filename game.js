...
const ui = {
  es: {
    ...
    languageGateAria: "Elegí con qué lenguaje empezar",
    languageGateTitle: "¿Con qué lenguaje querés empezar?",
    languageGateIntro: "Java Werkstatt y Python Studio comparten el mismo camino de aprendizaje EF/NRW. Elegí uno para arrancar; podés cambiar cuando quieras.",
    languageGateJavaTitle: "Java Werkstatt",
    languageGateJavaDesc: "IDE completo, 49 misiones y proyectos hacia Q2.",
    languageGatePythonTitle: "Python Studio",
    languageGatePythonDesc: "Fundamentos de programación con Python real.",
    languageGateChoose: "Elegir",
  ...
  de: {
    ...
    languageGateAria: "Wähle, mit welcher Sprache du starten möchtest",
    languageGateTitle: "Mit welcher Sprache möchtest du starten?",
    languageGateIntro: "Java Werkstatt und Python Studio teilen denselben EF/NRW-Lernpfad. Wähle eine zum Starten – du kannst jederzeit wechseln.",
    languageGateJavaTitle: "Java Werkstatt",
    languageGateJavaDesc: "Vollständige IDE, 49 Missionen und Projekte bis Q2.",
    languageGatePythonTitle: "Python Studio",
    languageGatePythonDesc: "Programmiergrundlagen mit echtem Python.",
    languageGateChoose: "Auswählen",
